...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'AMCEC@gmail.com' ")
...
window.configure(background='#301934')
...
message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System", fg="white", bg="#301934",
...
datef = tk.Label(frame4, text=day + "-" + mont[month] + "-" + year + "  |  ", fg="#c4c6ce", bg="#301934", width=55,
                 height=1, font=('comic', 17, ' bold '))
datef.pack(fill='both', expand=1)

clock = tk.Label(frame3, fg="#ff61e5", bg="#301934", width=55, height=1, font=('comic', 17, ' bold '))
